...
| `reports/evaluation_llm_agent_v2_pilot_stage8_6.json` | Stage 8.6 唯一一次 40 题 pilot 自动指标与 trace |
| `reports/evaluation_llm_agent_v2_pilot_stage8_6_state.json` | pilot `completed_once`、实现 commit 和 report 哈希 |
| `reports/evaluation_llm_agent_v2_pilot_stage8_6_gate.json` | 预声明 Go/No-Go 判定、禁止重跑和禁止逐题调参状态 |
