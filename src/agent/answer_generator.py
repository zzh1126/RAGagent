...
from src.schemas import AnswerPayload, GraphPath, GraphTriple, RetrievalResult
...
class GroundedAnswerGenerator:
    ...
    def _append_entity_definition_claim(self, retrieval: RetrievalResult, evidence_by_chunk: dict, claims: list[dict]) -> None:
    ...
    def _append_comparison_context(self, retrieval: RetrievalResult, evidence_by_chunk: dict, claims: list[dict]) -> None:
        seen = {claim.get("claim") for claim in claims}
